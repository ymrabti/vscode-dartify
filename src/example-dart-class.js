...
function test() {
    ...
    const dart = generateClass(dartData, nooThanks, JSON.stringify(json))
    // const dirr = resolve(__dirname, '../outs', 'example.dart');
    const farma = 'C:/Users/youmt/Programminng/Flutter/my-apps/Botola MAX/lib/logic/profile_test.dart'
    writeFile(farma,
        dart, (err) => {
            if (err) {
                console.error(err);
